...
// nolint: dupl
func (qs RepoAnalysisQuerySet) ResultJSONEq(resultJSON []byte) RepoAnalysisQuerySet {
	return qs.w(qs.db.Where("result_json = ?", resultJSON))
}

// ResultJSONIn is an autogenerated method
// nolint: dupl
func (qs RepoAnalysisQuerySet) ResultJSONIn(resultJSON ...[]byte) RepoAnalysisQuerySet {
	if len(resultJSON) == 0 {
...
// nolint: dupl
func (qs RepoAnalysisQuerySet) ResultJSONNe(resultJSON []byte) RepoAnalysisQuerySet {
	return qs.w(qs.db.Where("result_json != ?", resultJSON))
}

// ResultJSONNotIn is an autogenerated method
// nolint: dupl
func (qs RepoAnalysisQuerySet) ResultJSONNotIn(resultJSON ...[]byte) RepoAnalysisQuerySet {
	if len(resultJSON) == 0 {
...
// nolint: dupl
func (u RepoAnalysisUpdater) SetResultJSON(resultJSON []byte) RepoAnalysisUpdater {
