...
func (m *MockLinter) Run(ctx context.Context, sg *result.StepGroup, exec executors.Executor, buildConfig *config.Service) (*result0.Result, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Run", ctx, sg, exec, buildConfig)
...
func (mr *MockLinterMockRecorder) Run(ctx, sg, exec, buildConfig interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Run", reflect.TypeOf((*MockLinter)(nil).Run), ctx, sg, exec, buildConfig)
}
