...
// nolint: dupl
func (qs RepoAnalysisQuerySet) DeleteNum() (int64, error) {
	db := qs.db.Delete(RepoAnalysis{})
	return db.RowsAffected, db.Error
}

// DeleteNumUnscoped is an autogenerated method
// nolint: dupl
func (qs RepoAnalysisQuerySet) DeleteNumUnscoped() (int64, error) {
	db := qs.db.Unscoped().Delete(RepoAnalysis{})
	return db.RowsAffected, db.Error
}
