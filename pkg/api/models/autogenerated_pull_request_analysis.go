...
// nolint: dupl
func (qs PullRequestAnalysisQuerySet) DeleteNum() (int64, error) {
	db := qs.db.Delete(PullRequestAnalysis{})
	return db.RowsAffected, db.Error
}

// DeleteNumUnscoped is an autogenerated method
// nolint: dupl
func (qs PullRequestAnalysisQuerySet) DeleteNumUnscoped() (int64, error) {
	db := qs.db.Unscoped().Delete(PullRequestAnalysis{})
	return db.RowsAffected, db.Error
}
