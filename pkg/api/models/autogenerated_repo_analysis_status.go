...
// nolint: dupl
func (qs RepoAnalysisStatusQuerySet) DeleteNum() (int64, error) {
	db := qs.db.Delete(RepoAnalysisStatus{})
	return db.RowsAffected, db.Error
}

// DeleteNumUnscoped is an autogenerated method
// nolint: dupl
func (qs RepoAnalysisStatusQuerySet) DeleteNumUnscoped() (int64, error) {
	db := qs.db.Unscoped().Delete(RepoAnalysisStatus{})
	return db.RowsAffected, db.Error
}
...
// IsEmptyEq is an autogenerated method
// nolint: dupl
func (qs RepoAnalysisStatusQuerySet) IsEmptyEq(isEmpty bool) RepoAnalysisStatusQuerySet {
	return qs.w(qs.db.Where("is_empty = ?", isEmpty))
}

// IsEmptyIn is an autogenerated method
// nolint: dupl
func (qs RepoAnalysisStatusQuerySet) IsEmptyIn(isEmpty ...bool) RepoAnalysisStatusQuerySet {
	if len(isEmpty) == 0 {
		qs.db.AddError(errors.New("must at least pass one isEmpty in IsEmptyIn"))
		return qs.w(qs.db)
	}
	return qs.w(qs.db.Where("is_empty IN (?)", isEmpty))
}

// IsEmptyNe is an autogenerated method
// nolint: dupl
func (qs RepoAnalysisStatusQuerySet) IsEmptyNe(isEmpty bool) RepoAnalysisStatusQuerySet {
	return qs.w(qs.db.Where("is_empty != ?", isEmpty))
}

// IsEmptyNotIn is an autogenerated method
// nolint: dupl
func (qs RepoAnalysisStatusQuerySet) IsEmptyNotIn(isEmpty ...bool) RepoAnalysisStatusQuerySet {
	if len(isEmpty) == 0 {
		qs.db.AddError(errors.New("must at least pass one isEmpty in IsEmptyNotIn"))
		return qs.w(qs.db)
	}
	return qs.w(qs.db.Where("is_empty NOT IN (?)", isEmpty))
}
...
// SetIsEmpty is an autogenerated method
// nolint: dupl
func (u RepoAnalysisStatusUpdater) SetIsEmpty(isEmpty bool) RepoAnalysisStatusUpdater {
	u.fields[string(RepoAnalysisStatusDBSchema.IsEmpty)] = isEmpty
	return u
}
...
var RepoAnalysisStatusDBSchema = struct {
	...
	IsEmpty                    RepoAnalysisStatusDBSchemaField
	...
	IsEmpty:                    RepoAnalysisStatusDBSchemaField("is_empty"),
