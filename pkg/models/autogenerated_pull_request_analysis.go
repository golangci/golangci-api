...
// PreloadRepo is an autogenerated method
// nolint: dupl
func (qs PullRequestAnalysisQuerySet) PreloadRepo() PullRequestAnalysisQuerySet {
	return qs.w(qs.db.Preload("Repo"))
}
...
// SetRepo is an autogenerated method
// nolint: dupl
func (u PullRequestAnalysisUpdater) SetRepo(repo Repo) PullRequestAnalysisUpdater {
	u.fields[string(PullRequestAnalysisDBSchema.Repo)] = repo
	return u
}
...
var PullRequestAnalysisDBSchema = struct {
	...
	Repo                PullRequestAnalysisDBSchemaField
	...
	Repo:                PullRequestAnalysisDBSchemaField("repo"),
