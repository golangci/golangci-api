...
// nolint: dupl
func (qs RepoAnalysisStatusQuerySet) PreloadRepo() RepoAnalysisStatusQuerySet {
...
// nolint: dupl
func (u RepoAnalysisStatusUpdater) SetRepo(repo Repo) RepoAnalysisStatusUpdater {
	u.fields[string(RepoAnalysisStatusDBSchema.Repo)] = repo
	return u
}
...
var RepoAnalysisStatusDBSchema = struct {
	...
	Repo                       RepoAnalysisStatusDBSchemaField
	...
	Repo:                       RepoAnalysisStatusDBSchemaField("repo"),
